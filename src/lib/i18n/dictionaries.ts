...
const dict = {
  ...
  type_restaurant: { uz: "Restoran", ru: "Ресторан", en: "Restaurant" },
  type_cafe: { uz: "Kafe", ru: "Кафе", en: "Cafe" },
  type_coffee_shop: { uz: "Kofexona", ru: "Кофейня", en: "Coffee shop" },
  type_tea_house: { uz: "Choyxona", ru: "Чайхана", en: "Tea house" },
  type_fast_food: { uz: "Fast-fud", ru: "Фастфуд", en: "Fast food" },
  type_bakery: { uz: "Nonvoyxona", ru: "Пекарня", en: "Bakery" },
  type_street_food: { uz: "Ko'cha taomlari", ru: "Уличная еда", en: "Street food" },
  type_canteen: { uz: "Oshxona", ru: "Столовая", en: "Canteen" },
  type_dessert_shop: { uz: "Shirinliklar", ru: "Десерты", en: "Desserts" },
  type_bar: { uz: "Bar", ru: "Бар", en: "Bar" },
  ...
  field_name_ru: { uz: "Nomi (ru)", ru: "Название (ru)", en: "Name (ru)" },
  field_name_en: { uz: "Nomi (en)", ru: "Название (en)", en: "Name (en)" },
  field_address: { uz: "Manzil", ru: "Адрес", en: "Address" },
  field_price_bucket: { uz: "Narx toifasi", ru: "Ценовая категория", en: "Price bucket" },
  save_changes: { uz: "Saqlash", ru: "Сохранить", en: "Save changes" },
  delete_restaurant: { uz: "Joyni o'chirish", ru: "Удалить место", en: "Delete place" },
  ...
  field_hours: { uz: "Ish vaqti", ru: "Часы работы", en: "Working hours" },
  day_0: { uz: "Dushanba", ru: "Понедельник", en: "Mon" },
  day_1: { uz: "Seshanba", ru: "Вторник", en: "Tue" },
  day_2: { uz: "Chorshanba", ru: "Среда", en: "Wed" },
  day_3: { uz: "Payshanba", ru: "Четверг", en: "Thu" },
  day_4: { uz: "Juma", ru: "Пятница", en: "Fri" },
  day_5: { uz: "Shanba", ru: "Суббота", en: "Sat" },
  day_6: { uz: "Yakshanba", ru: "Воскресенье", en: "Sun" },
  hours_closed: { uz: "Yopiq", ru: "Закрыто", en: "Closed" },
  hours_24h: { uz: "24 soat", ru: "Круглосуточно", en: "24h" },
  hours_copy_to_all: { uz: "Barcha kunlarga nusxalash", ru: "Скопировать на все дни", en: "Copy to all days" },
  admin_empty: {
  ...
  field_media: { uz: "Rasmlar (ixtiyoriy)", ru: "Фото (необязательно)", en: "Photos (optional)" },
