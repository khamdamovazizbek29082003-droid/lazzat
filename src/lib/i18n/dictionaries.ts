...
const dict = {
  ...
  admin_tab_claims: { uz: "Egalik", ru: "Владение", en: "Claims" },
  admin_claims_empty: { uz: "Egalik so'rovlari yo'q ✓", ru: "Запросов на владение нет ✓", en: "No ownership claims pending ✓" },

  claim_this_place: { uz: "Bu joyning egasimisiz?", ru: "Это ваше заведение?", en: "Is this your business?" },
  claim_this_place_cta: { uz: "Egalikni tasdiqlash", ru: "Подтвердить владение", en: "Claim this listing" },
  claim_form_title: { uz: "Egalikni tasdiqlash", ru: "Подтверждение владения", en: "Claim this listing" },
  claim_form_subtitle: {
  ...
  field_evidence_type: { uz: "Tasdiqlash usuli", ru: "Способ подтверждения", en: "Verification method" },
  evidence_phone: { uz: "Telefon orqali", ru: "По телефону", en: "Phone verification" },
  evidence_document: { uz: "Hujjat", ru: "Документ", en: "Document" },
  evidence_utility_bill: { uz: "Kommunal to'lov kvitansiyasi", ru: "Квитанция об оплате ЖКУ", en: "Utility bill" },
  evidence_other: { uz: "Boshqa", ru: "Другое", en: "Other" },
  field_evidence_photo: { uz: "Hujjat rasmi (ixtiyoriy)", ru: "Фото документа (необязательно)", en: "Evidence photo (optional)" },
  submit_claim: { uz: "Yuborish", ru: "Отправить", en: "Submit claim" },
  claim_sent_toast: {
  ...
  claim_already_sent: { uz: "Siz allaqachon so'rov yubordingiz.", ru: "Вы уже отправили запрос.", en: "You've already submitted a claim." },
  my_restaurants: { uz: "Mening joylarim", ru: "Мои заведения", en: "My restaurants" },
