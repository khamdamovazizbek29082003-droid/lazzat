...
export const DISH_PHOTOS = {
  ...
  somsa: {
    key: "somsa",
    url: pexels("23286188"),
    name: { uz: "Somsa", ru: "Самса", en: "Somsa" },
    credit: "Pexels",
  ...
  non: {
    key: "non",
    url: pexels("10337726"),
    name: { uz: "Non (tandir noni)", ru: "Лепёшка", en: "Tandir bread (non)" },
    credit: "Pexels",
  ...
  teahouse: {
    ...
    name: { uz: "Choyxona", ru: "Чайхана", en: "Teahouse" },
    credit: "Unsplash",
  ...
  coffee: {
    ...
    name: { uz: "Kofe", ru: "Кофе", en: "Coffee" },
    credit: "Unsplash",
  ...
  dessert: {
    key: "dessert",
    url: pexels("20183046"),
    name: { uz: "Shirinlik (baklava)", ru: "Пахлава", en: "Baklava" },
    credit: "Pexels",
